...
class GoodsMarket:
    ...
    def getCurrentInflation(self):
        return (self.currentPrice-self.pastPrices[-1])/self.pastPrices[-1] if self.economy.currentPeriod > 1 else 0
    ...
    def nextPeriod(self):
        ...
        assert len(self.pastPrices) == self.economy.currentPeriod